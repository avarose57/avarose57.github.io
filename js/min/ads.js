...
}}y[w](v+"DOMContentLoaded",t,false);
y[w](v+"readystatechange",t,false);
C[w](v+"load",t,false);
...
k=this.hasAds();
hasTnT=this.hasTnT();
if(btg.config.Freewheel.adBlockerDetection){new btg.Ajax({xDomain:true,autoSend:true,onerror:function(){btg.globalvars.FW_BLOCKED=true;
},onload:function(){btg.globalvars.FW_BLOCKED=false;
},url:location.protocol+"//web.archive.org/web/20140104082304/http://140cc.v.fwmrm.net/ad/l/1?s="});
...
if(typeof c.length==="number"&&!c.propertyIsEnumerable("length")){j=c.length;
for(i=0;
i<j;
...
var e={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};
return{stringify:d,parse:function(c,d){function e(c,f){var i,k;
if(f&&typeof f==="object"){for(i in f){if(Object.prototype.hasOwnProperty.apply(f,[i])){k=e(i,f[i]);
...
if(btg.String.isDefined(q.fn)){var o=q.fn.split("."),c=o.pop(),d=h,t=0;
for(s=o.length;
t<s;
t++){d=d[o[t]];
...
this.checkDependency=function(w){for(var v=null,u=0,t=j.length;
u<t;
u++){if(j[u].flagname==w){v=j[u];
}}if(!v){return false;
}if(v.callback.apply()){this.remove(w);
}else{var h=this;
window.setTimeout(function(){h.checkDependency(w);
},v.interval);
}};
...
btg.GUID=new function(){var s=null,q=null,o=function(){var d=btg.Cookie.read("vmn_uuid");
if(typeof d=="string"){q=d;
...
this.hasGUIDCookie=function(){return o();
};
this.get3pcCookie=function(){var d=btg.Cookie.read("vmn_3pc");
return !btg.String.isDefined(d)?null:d;
};
this.init=function(c){s=c;
if(!l()){btg.Cookie.set("vmn_uuid","","Thu, 01-Jan-70 00:00:01 GMT;");
btg.Cookie.set("mtvn_guid","","Thu, 01-Jan-70 00:00:01 GMT;");
return false;
}if(typeof s.guidIdVarMap=="undefined"){s.guidIdVarMap=["eVar57"];
}if(typeof s.guidIdVarMap=="string"){s.guidIdVarMap=s.guidIdVarMap.split(",");
}return true;
};
this.run=function(e){if(!l()){return e;
}if(!o()){new btg.Alert("Failed to find the UUID value.");
return e;
}for(var d=0,c=s.guidIdVarMap.length;
d<c;
d++){e[s.guidIdVarMap[d]]=q;
...
}catch(e$$21){}btg.ReportingManager=new function(){var t=false,q=false,s=false,o,j,u,l,k=false;
...
f.eVar67=(e?e:"EMPTY")+"_"+(new Date).getTime();
...
f.src=["//web.archive.org/web/20140104082304/http://secure-us.imrworldwide.com/cgi-bin/m?ci="+h+"&cg="+e+"&cc=1&si=",g,"&rp=",escape(document.referrer),"&ts=compact&rnd=",(new Date).getTime()].join("");
...
}catch(e$$4){}btg.Preload=function(){this.playUpUrl=location.protocol+"//web.archive.org/web/20140104082304/http://media.mtvnservices.com/player/images/Button_playBig_upSkin.png";
this.playOverUrl=location.protocol+"//web.archive.org/web/20140104082304/http://media.mtvnservices.com/player/images/Button_playBig_overSkin.png";
...
f.setAttribute("src",location.protocol+"//web.archive.org/web/20140104082304/http://media.mtvnservices.com/"+g);
...
this.url=((y(this.config.ssl)||location.protocol=="https:"?"https:":"http:")+"//web.archive.org/web/20140104082304/http://ad.doubleclick.net/"+c(this)+"/"+v(this)+"/"+u(this)+"/"+t(this)+"/"+s(this)+q(this)+";"+g(this)).substring(0,1024);
}};
};
...
return{init:function(){this.configure();
this.url=((t(this.config.ssl)||location.protocol=="https:"?"https:":"http:")+"//web.archive.org/web/20140104082304/http://ad.doubleclick.net/"+d(this)+q(this)+"/"+o(this)+"/"+g(this)+";"+e(this)).substring(0,1024);
}};
};
...
return{init:function(){this.configure();
this.url=((v(this.config.ssl)||location.protocol=="https:"?"https:":"http:")+"//web.archive.org/web/20140104082304/http://ad.mo.doubleclick.net/DARTProxy/mobile.handler?"+d(this)+"&"+c(this)).substring(0,1024);
}};
};
...
if(e()){c.DOM.loadScript("//web.archive.org/web/20140104082304/http://daapiak.flux.com/2.0/00001/json/"+c.config.Flux.communityId+"/feeds/widgets4ContextShortest?windowVariable=Widgets4Context");
}})(btg);
...
try{if(!btg.globalvars.IS_UNIT_TEST&&!d.isScriptIncluded.comscore){btg.DOM.loadScript((document.location.protocol=="https:"?"https://web.archive.org/web/20140104082304/https://sb":"http://b")+".scorecardresearch.com/beacon.js?"+e);
...
document.write('<script language="Javascript1.2" src="https://web.archive.org/web/20140104082304/http://admin5.testandtarget.omniture.com/admin/mbox/mbox_debug.jsp?mboxServerHost=mtvnetworks.tt.omtrdc.net&clientCode=mtvnetworks"><\/script>');
...
var j="https://web.archive.org/web/20140104082304/http://ad.doubleclick.net/ad/nickjr.nol/hp_printables;adid=227986931;sz=1x1;ord=2654564545?";
...
/*
     FILE ARCHIVED ON 08:23:04 Jan 04, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:09:57 Aug 14, 2025.
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 2200.512
  LoadShardBlock: 277.901 (3)
  PetaboxLoader3.datanode: 239.653 (5)
  load_resource: 462.844 (2)
  PetaboxLoader3.resolve: 353.483 (2)
*/
